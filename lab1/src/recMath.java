...
public class recMath {
	public static void main(String[] args) {
		System.out.println("Some recursive math");
		...
		System.out
				.println("Enter a number to get its H function - MY SYSTEM!!!!!!!!!!");
		// int num2 = read.nextInt();
		...
		System.out
				.println("Enter a number and get the Fibonacci series up to that number");
